...
**First wedge:** CLI review on exact HEAD → SHIP / DO NOT SHIP verdict with cited evidence → GitHub App. CLI v0 ships in this repo (`bin/sentinel.js`, rule-pack v1.4.0: 23 deterministic rules, see `docs/rulepack-v1.4.md`).
...
sentinel review --pr 42 --rule-pack 1.0.0  # pinned 6-rule pack (1.1.0: 20 rules, 1.2.0: 21, 1.3.0: 22, 1.4.0: 23, default)
...
Full suite: `npm test` — 445 tests green, 0 fail (rule packs: 1.0.0 = 6 rules,
1.1.0 = 20, 1.2.0 = 21, 1.3.0 = 22, 1.4.0 = 23 per `lib/rulepack.js`).
