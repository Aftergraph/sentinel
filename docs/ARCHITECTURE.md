...
| `lib/rulepack.js` | Single source of truth: rule IDs, severities, pack versions, blocking set | `RULE_PACK_VERSION` (`1.4.0`), `SUPPORTED_PACKS` (`1.0.0\|1.1.0\|1.2.0\|1.3.0\|1.4.0`), `RULE_IDS_BY_PACK`, `SEVERITY_MAP`, `BLOCKING_SEVERITIES`, `ruleIdsForPack` |
...
1.4.0 = 23 (pinned by `test/cli-contract.test.mjs`).
...
`--rule-pack 1.0.0|1.1.0|1.2.0|1.3.0|1.4.0`, `--policy`, `--override
