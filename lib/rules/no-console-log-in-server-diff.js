...
// CLI entrypoints print results to stdout: console.log there is the output
// mechanism, not leftover debugging (same exemption as wave-17 for
// process-exit; the rule targets server code per its name).
// bench/ reporters print scores to stdout the same way: the print IS the
// interface, never leftover debugging.
const ENTRYPOINT_RE = /(^|\/)bin\/|(^|\/)bench\//;
