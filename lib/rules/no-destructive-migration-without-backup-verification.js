...
// Commented-out SQL never executes (adversarial wave-22). Note the
// asymmetry is deliberate: the backup-reference hatch DOES read comments
// (`-- Verified backup: pg_dump ...` is the documented contract — SQL has
// no uncommented metadata channel), but the destructive signal does not.
